...
int main() {
	...
	int n1, n2;
	cin >> n1 >> n2;
	BinaryTreeNode<int> * first = new BinaryTreeNode<int>(n1);
	BinaryTreeNode<int> * second = new BinaryTreeNode<int>(n2);
	if (!LCA(root, first , second)) {
		cout << "NULL";
	}
	else {
		cout << LCA(root, first, second)->data;
	}
	return 0;
}
